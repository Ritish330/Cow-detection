...
def select_and_plot():
    # Load the YOLOv5s model with a custom 300.pt file
    custom_model_path = "weights/300.pt"  # Replace with the path to your custom 300.pt file
    yolov5s_model = torch.hub.load("ultralytics/yolov5", "custom", source="local", path=custom_model_path)
